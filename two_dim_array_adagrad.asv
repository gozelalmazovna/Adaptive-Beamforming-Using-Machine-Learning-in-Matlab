function [weighty,weightz,AF] = two_dim_array_adagrad(My,Nz,dy,dz,lam,theta_desired,theta_interfered)
...
weighty=adagrad(My,dy,lam,theta_desired,theta_interfered);
weightz=adagrad(Nz,dz,lam,theta_desired,theta_interfered);
